export const ROOMS = {
  shore: {
    ...
    walls: [
      { x: 0, y: 0, w: 800, h: 18 },
      { x: 0, y: 582, w: 800, h: 18 },
      { x: 0, y: 0, w: 18, h: 600 },
      { x: 782, y: 0, w: 18, h: 600 },
      { x: 0, y: 18, w: 94, h: 242 },
      { x: 0, y: 360, w: 110, h: 222 },
      { x: 94, y: 18, w: 170, h: 72 },
      { x: 188, y: 92, w: 105, h: 48 },
      { x: 330, y: 0, w: 470, h: 82 },
      { x: 690, y: 82, w: 92, h: 58 },
      { x: 420, y: 95, w: 112, h: 58 },
      { x: 330, y: 324, w: 112, h: 45 },
      { x: 618, y: 337, w: 148, h: 42 },
      { x: 540, y: 495, w: 172, h: 62 },
      { x: 112, y: 388, w: 168, h: 42 },
    ],
    doors: [
      { id: "shore_to_forest", x: 705, y: 150, w: 64, h: 118, to: "forest_path", spawn: "from_shore", label: "Bosque" },
    ],
    spawns: {
